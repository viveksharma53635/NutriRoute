...
const SubscriptionDashboard = () => {
  ...
  const { subscription, isFreeUser, isProUser, isPremiumUser } = useSubscription();
  ...
  const fetchUserData = async () => {
    try {
      // Get user ID from LoginContext or localStorage
      const user = JSON.parse(localStorage.getItem("user"));
      if (user && user.id) {
        const response = await authService.getUserSubscription(user.id);
  ...
  const handleFeatureClick = async (feature, endpoint) => {
    try {
      const response = await authService.get(endpoint);
      console.log('Feature access granted:', response.data);
    } catch (error) {
      console.error('Feature access denied:', error);
    }
  };
          ...
          <div className="col-md-3">
            <div className="card border-0 shadow-sm">
              <div className="card-body text-center">
                ...
                <h4 className="fw-bold">{userData?.bmi || 'N/A'}</h4>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card border-0 shadow-sm">
              <div className="card-body text-center">
                ...
                <h4 className="fw-bold">{userData?.dailyCalorieTarget || 'N/A'}</h4>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card border-0 shadow-sm">
              <div className="card-body text-center">
                ...
                <h4 className="fw-bold">{userData?.mealsLogged || 0}</h4>
              </div>
            </div>
          </div>
          <div className="col-md-3">
              ...
              <div className="card border-0 shadow-sm h-100 feature-card">
                <div className="card-body">
                  ...
                  <button 
                    ...
                    onClick={() => handleFeatureClick('basic_diet_plan', '/api/features/basic-diet-plan')}
                  >
              ...
              <div className="card border-0 shadow-sm h-100 feature-card">
                <div className="card-body">
                  ...
                  <button 
                    ...
                    onClick={() => handleFeatureClick('advanced_meals', '/api/features/advanced-meals')}
                  >
                    <i className="bi bi-arrow-right me-2"></i>
                    Access Feature
                  </button>
              ...
              <div className="card border-0 shadow-sm h-100 feature-card">
                <div className="card-body">
                  ...
                  <button 
                    ...
                    onClick={() => handleFeatureClick('nutrition_tracking', '/api/features/nutrition-tracking')}
                  >
                    <i className="bi bi-arrow-right me-2"></i>
                    Access Feature
                  </button>
            ...
            <SubscriptionGuard feature="ai_diet_recommendation">
              <div className="card border-0 shadow-sm h-100 feature-card">
                <div className="card-body">
                  ...
                  <p className="text-muted mb-3">
                    Get AI-powered personalized diet recommendations based on your health goals and preferences.
                  </p>
                  <button 
                    className="btn btn-info w-100"
                    onClick={() => handleFeatureClick('ai_diet_recommendation', '/api/features/ai-diet')}
                  >
                    <i className="bi bi-arrow-right me-2"></i>
                    Access Feature
                  </button>
            ...
            <SubscriptionGuard feature="custom_diet_plan">
              <div className="card border-0 shadow-sm h-100 feature-card">
                <div className="card-body">
                  ...
                  <p className="text-muted mb-3">
                    Create fully customized diet plans tailored to your specific dietary needs and preferences.
                  </p>
                  <button 
                    className="btn btn-primary w-100"
                    onClick={() => handleFeatureClick('custom_diet_plan', '/api/features/custom-diet-plan')}
                  >
                    <i className="bi bi-arrow-right me-2"></i>
                    Access Feature
                  </button>
